...
if(readCookie('authToken')){
	let userInfo = jwt_decode(readCookie('authToken'));
	...
	let emailE = document.getElementById("EMAIL_ADDRESS");
	let firstNameE = document.getElementById("FIRST_NAME");
	let lastNameE = document.getElementById("LAST_NAME");
	let phoneE = document.getElementById("PHONE_NUMBER");
